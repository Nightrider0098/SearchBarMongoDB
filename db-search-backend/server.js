...
// const { query } = require('./mysql_connector');
...
app.get("/SearchBig", (req, res) => {
    ...
    mysqlConnector.query('select count(*) from ' + database_name, (error, result) => {
        ...
        mysqlConnector.query('select * from ' + database_name + ' where name like "%1%" limit 0,' + String(db_length / partitionDb), (error, result) => {
...
app.get("/SearchBigContinue", (req, res) => {
    ...
    var db_length = req.query.dbLength || 10000
    var database_name = req.query.dbName || 'emp2'
    console.log(index)
    var timeStamp = new Date()
    mysqlConnector.query('select * from ' + database_name + ' where name like "%1%" limit ' + parseInt(index * db_length / partitionDb) + ',' + db_length / partitionDb, (error, result) => {
...
app.get('/home', (req, res) => {
    res.sendFile('C:\\Users\\Admin\\Desktop\\Project\\USA\\progressBar.html')
})
